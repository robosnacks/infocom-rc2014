...
;Configured for the LEAR SIEGLER ADM3
...
CPMCPL: DB 78  ;Characters/line (132 maximum)
CPMLPP: DB 23  ;Lines/screen (NOT including status line)
CPMFN: DB 'ZORK3',20H,20H,20H
   ;File name (DO NOT CHANGE THIS)
   ;actually DO CHANGE THIS!
